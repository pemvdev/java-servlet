...
<body>
    <div class="login-container">
        ...
        <% } %>
        <% if ("user-not-found".equals(request.getParameter("error"))) { %>
            <div class="error-message">
                Usuário não encontrado.
            </div>
        <% } %>
        <% if ("wrong-password".equals(request.getParameter("error"))) { %>
            <div class="error-message">
                Senha incorreta.
            </div>
        <% } %>
        ...
        <% if ("1".equals(request.getParameter("created"))) { %>
            <div class="error-message" style="border-color: rgba(34, 197, 94, 0.3); color: #86efac; background: rgba(34, 197, 94, 0.1);">
        ...
        <form action="login" method="post">
            ...
            <a class="register-link" href="${pageContext.request.contextPath}/register.jsp">
                Criar conta
            </a>
